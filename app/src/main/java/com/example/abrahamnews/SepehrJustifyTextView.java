...
public class SepehrJustifyTextView extends View {


/**
 * {@link SepehrJustifyTextView} with both ends alignment.
 *
 * @author jooloo
 */
    ...
    public SepehrJustifyTextView(Context context) {
        this(context, null);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SepehrJustifyTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SepehrJustifyTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SepehrJustifyTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    /**
     * Set the text displayed in the {@link SepehrJustifyTextView}
     */
    ...
    public float getLetterSpacing() {
        return Build.VERSION.SDK_INT >= 21 ? mTextPaint.getLetterSpacing() : 0;
    }
